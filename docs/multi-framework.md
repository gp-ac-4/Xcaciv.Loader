...
By default, the project targets .NET 8.0 for maximum compatibility.
...
# Build for .NET 10.0
dotnet build /p:UseNet10=true

# Test for .NET 8.0
dotnet test

# Test for .NET 10.0
dotnet test /p:UseNet10=true
```
